...
docker run -dt  --name n8n  -p 7088:5678 -e GENERIC_TIMEZONE="Asia/Kolkata"  -e TZ="Asia/Kolkata" -e WEBHOOK_URL="https://n$app_url" -v /mnt/DriveDATA/n8n:/home/node/.n8n docker.n8n.io/n8nio/n8n:1.71.2
